...
const ThirdPage = () => {
  ...
  return (
    <section className="w-full min-h-screen text-white flex items-center justify-center px-6 py-12">
      <div
        className="w-full max-w-[1440px] bg-cover bg-center bg-no-repeat rounded-[30px] overflow-hidden p-10"
          ...
          {cards.map((card, index) => {
            ...
            return (
              <div
                ...
                className={`relative w-full max-w-[280px] bg-opacity-90 rounded-[20px] px-6 py-8 cursor-pointer shadow-md transition-all duration-500 ease-in-out`}
